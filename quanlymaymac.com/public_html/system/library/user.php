...
/**
 * User Authentication Library For SA Framework
 *
...
class user
{
	...
	public static function create($user)
	{
		...
		//if(!($user['type'] = array_search($user['type'],self::$types)))
            //throw new SAException('Type not found!');
...
/**
 * User Authentication Library User Update Class For SA Framework
 *
 * @author          Hoang Trong Hoi
 * @copyright       2011
 */
