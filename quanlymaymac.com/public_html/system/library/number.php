...
class number
{
	 ...
	 * 
	 * @param  number|string $number     The positive integer to convert
	...
	{
		if ($number instanceof number && $from_base != 10) {
			throw new SAException(
				'The from base specified, %s, is not valid for an number object',
				$from_base
			);
		}
		...
		if (!is_numeric($to_base) || $to_base < 2 || $to_base > 16) {
			throw new SAException('The to base specified, %1$s, is not valid base between %2$s and %3$s',
				$from_base,
				'2',
				'16'
			);
		...
		if ($from_base != 10) {
			...
			$base_num = new number($from_base);
			
			for($i = 0; $i < $length; $i++) {
				$char  = strtoupper($number[$i]);
				$value = new number((isset($base_map[$char])) ? $base_map[$char] : $char);
	 ...
	 * 
	 * @throws Exception  When `$number1` or `$number2` is not a valid number
	 * 
	 * @param  number|string $number1  The first number to normalize
	 * @param  number|string $number2  The second number to normalize
	 ...
	 * 
	 * @throws Exception  When `$number` is not a valid number
	 * 
	 ...
	 * 
	 * @throws Exception  When `$dividend` or `$divisor` is not a valid number
	 * 
	 ...
	 * 
	 * @throws  Exception  When `$number` or `$power` is not a valid number or when `$power` is outside of the normal 32-bit integer range
	 * 
	 ...
	 * 
	 * @throws Exception  When `$minuend` or `$subtrahend` is not a valid number
	 * 
	 ...
	 * 
	 * @param  callback $callback  The callback to pass the number value to - see method description for parameters
	 * @return void
	 */
	 ...
	 * 
	 * @throws Exception  When `$value` is not a valid number
	 * 
	...
	public function abs($scale=NULL)
	{
		...
		return new number(substr($this->value, 1), $scale);
	}
	 ...
	 * Adds two numbers together
	 * 
	 * @throws Exception  When `$addend` is not a valid number
	 * 
	 * @param  number|string $addend  The addend
	 * @param  integer        $scale   The number of places after the decimal - overrides the scale for this number
	 ...
	 * 
	 * @return number  The next highest integer
	 */
	public function ceil()
	{
		...
		return new number(self::performAdd($integer, '1'));
	}
	 ...
	 * 
	 * @throws Exception  When `$divisor` is not a valid number
	 * 
	 ...
	 * @throws Exception  When `$number` is not a valid number
	 * 
	 * @param  number|string $number  The number to compare to
	 ...
	 * 
	 * @return number  The next lowest integer
	 */
	public function floor()
	{
		...
		return new number(self::performSub($integer, '1'));
	}
	 ...
	 * @throws Exception  When `$divisor` is not a valid number 
	 * 
	 * @param  number|string $divisor  The divisor - will be converted to an integer if it is a float
	 * @return number  The remainder
	 */
	 ...
	 * Multiplies two numbers
	 * 
	 * @throws Exception  When `$multiplier` is not a valid number 
	 * 
	 * @param  number|string $multiplier  The multiplier
	 * @param  integer        $scale       The number of places after the decimal - overrides the scale for this number
	 ...
	 * 
	 * @throws Exception  When `$exponent` is not a valid number 
	 * 
	 ...
	 * 
	 * @throws Exception  When `$exponent` or `$modulus` is not a valid number 
	 * 
	 * @param  number|string $exponent  The power to raise to - all non integer values will be truncated to integers
	 * @param  number|string $modulus   The value to divide by - all non integer values will be truncated to integers
	 * @return number  The remainder
	 */
	 ...
	 * 
	 * @throws  Exception  When `$subtrahend` is not a valid number 
	 * 
	 * @param  number|string $subtrahend  The subtrahend
	 * @param  integer        $scale       The number of places after the decimal - overrides the scale for this number
    ...
    public static function between($num1,$num2,$num3,$equal = true){
        return $equal?(($num1>=$num2)&&($num1<=$num3)):(($num1>$num2)&&($num1<$num3));
    }
