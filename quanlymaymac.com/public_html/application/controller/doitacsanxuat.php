...
class doitacsanxuat_controller extends controller{
    public function index(){
        ...
        if($login_type!='doitacsanxuat' && !($login_type=='admin'&&$employee->kho>0)){
        ...
        /*$infos['duans'] = $model->all(array(
            'conditions'=>array(                 
                array('kho','=',$kho) ,
                array('trangthai','=',1)                     
            ),
            'order' => array('ngay','desc'),
            'limit' => 5,
        ));*/
    ...
    public function lists(){ //var_dump('a');die();
        ...
        $admins = doitac::list_all($login_type=='doitacsanxuat'?$employee->id:$employee->kho,2);
