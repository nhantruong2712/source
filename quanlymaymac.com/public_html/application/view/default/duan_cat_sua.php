<? include(dirname(__FILE__).'/header.php') ?>
            ...
            <div class="app-main__outer duancat sua" data-id="<?=$kho?>" data-duan="<?=$model->id?>" data-cuonvai="<?=$model->cuonvai->id?>">
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Xem bàn cắt vải<div class="page-title-subheading">Dự án: <?=$model->ten?> <em>(<?=$model->ma?>)</em></div>
                                </div>
                            </div>
                        </div>
                    </div>  
                        ...
                        <div class="tab-pane tabs-animation fade active show" id="tab-content-0" role="tabpanel">
                                ...
                                <div class="card-body"><h5 class="card-title">Thông tin dự án</h5>
                                    <form class="">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="lopban" class="">Max lớp/bàn</label><input name="lopban" id="lopban" type="text" class="form-control" data-old="<?=$model->lopban?>" value="<?=$model->lopban?>" readonly /><span></span></div>
                                            </div>
                                             
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="splop" class="">Số sản phẩm/lớp</label><input name="splop" id="splop" type="text" class="form-control" data-old="<?=$model->splop?>" value="<?=$model->splop?>" readonly /><span></span></div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group">
                                                    <label for="solopcatdotnay" class="">Số lớp cắt đợt này</label>
                                                    <input name="solopcatdotnay" id="solopcatdotnay" type="text" class="form-control" 
                                                        data-old="<?=($model->splop==0?0:ceil($model->soluong/$model->splop))-$model->solopdacat?>" 
                                                        value="<?=($model->splop==0?0:ceil($model->soluong/$model->splop))-$model->solopdacat?>" 
                                                        <?=$model->duan_cuon->trangthai==1?'readonly':''?>
                                                    />
                                                </div>
                                            </div> 
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="cuonvai" class="">Cuộn vải cắt</label>
                                                    <select name="cuonvai" id="cuonvai" class="form-control" readonly>
                                                        <option value="<?=$model->cuonvai->id?>"><?=$model->cuonvai->ten?></option>
                                                    </select>
                                                </div>
                                            </div> 
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="soluongcuon" class="">Số lượng cuộn cắt</label><input name="soluongcuon" id="soluongcuon" type="text" class="form-control" value="<?=$model->duan_cuon->soluongcuon?>" readonly="" /><span></span></div>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="tamvai" class="">Tấm vải</label>
                                                    <select name="tamvai" id="tamvai" class="form-control" readonly>
                                                        <?php if($model->tamvai){?>
                                                        <option value="<?=$model->tamvai->id?>"><?=$model->tamvai->ten?></option>
                                                        <?php }?>
                                                    </select><span></span>
                                                </div>
                                            </div> 
                                            <div class="col-md-6">
                                                <div class="position-relative form-group"><label for="nhomban" class="">Sản phẩm Bàn cắt</label>
                                                    <select name="nhomban" id="nhomban" class="form-control" readonly>
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Danh sách bàn cắt</h5>
                                    <div class="row">
                                         <?php foreach($model->duan_cut as $ban){?>
                                         <div class="col-md-3" data-ban="<?=$ban->ban?>">
                                            <div class="mb-3 card text-white bg-primary">
                                                <div class="card-header">Table <?=$ban->ban+1?></div>
                                                <div class="card-body"><input type="text" class="form-control" value="<?=$ban->soluong?>" /></div>
                            ...
                            <?php if($model->duan_cuon->trangthai==0){?>
                            <div class="main-card mb-3 card">
                                <div class="card-body"> 
