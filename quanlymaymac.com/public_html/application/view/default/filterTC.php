                        ...
                        <div class="tab-pane tabs-animation fade active show" id="tab-content-0" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-3">
                                        <div class="card-header">Lọc theo dự án</div>
                                        <div class="mb-3">
                                            <div class="position-relative form-group">
                                                <label for="filterName" class="">Tên dự án</label>
                                                <select name="ten" id="filterName" class="form-control">
                                                    <?php if($product){?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-block text-right card-footer">                                             
                                            <button class="btn btn-warning btn-lg" id="dofiltertc">Lọc</button> 
                                        </div>  
                                    </div>
                                </div>
