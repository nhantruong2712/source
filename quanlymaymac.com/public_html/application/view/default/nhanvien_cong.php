...
//chấm công nhân viên tính trong bảng ngay   theo congdoan, ngay - inner join congdoan
 
$c = db::query("select ngay.ngay, ngay.doituong as nhanvien, ngay.soluong
    from ngay where ngay.ngay>='$x0' and ngay.ngay<='$x1' and ngay.type=1 and ngay.doituong =".$nhanvien->id);
//var_dump($c);die();
if($c){
    $c2 = array();
    foreach($c as $cc){
         
        $c2[$cc->ngay] = $cc->soluong;
...
?>
            ...
            <div class="app-main__outer bangtiendo chamcong month" data-id="<?=$nhanvien->id?>">
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Chấm công nhân viên<div class="page-title-subheading"><?=$nhanvien->ten?></div>
                                </div>
                            </div>
                                    ...
                                    <div class="fc-view fc-month-view fc-basic-view" style="">
                                      <table class="table-bordered">
                                        ...
                                        <tbody class="fc-body">
                                          <tr>
                                            <td class="">
                                              <div class="fc-scroller fc-day-grid-container" style="overflow: hidden; height: 336px;">
                                                <div class="fc-day-grid fc-unselectable">
                                                  <div class="fc-row fc-week table-bordered fc-rigid" style="">
                                                    <div class="fc-bg">
                                                      <table class="table-bordered">
                                                        <tbody>
                                                          <tr>
                                                    ...
                                                    <div class="fc-content-skeleton">
                                                      <table>
                                                        ...
                                                        <tbody>
                                                          ...
                                                          <tr>
                                                            <?php for($i=0;$i<7;$i++){?>
                                                            <?php if($start_month-($w-$i)*86400>$time2){?>
                                                            <td></td>
                                                            <?php }else{$value=empty($ret[$i])?0:($ret[$i]*100);?>
                                                            <td class="fc-event-container"><div class="progress-bar-rounded mb-3 progress">
                                                                <div class="progress-bar" role="progressbar" aria-valuenow="<?=$value?>" aria-valuemin="0" aria-valuemax="100" style="width: <?=$value?>%;"><?=$value/100?></div>
                                                            </div></td>
                                                            <?php }?>   
                                                            <?php }?>
                                                          </tr>
