<? include(dirname(__FILE__).'/header.php') ?>
            ...
            <div class="app-main__outer xuatnhap xuat" data-id="<?=$kho?>">
                <div class="app-main__inner">
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div class="page-title-icon">
                                    <i class="pe-7s-next-2 text-success">
                                    </i>
                                </div>
                                <div>Thêm đơn xuất hàng<div class="page-title-subheading">Thêm đơn xuất hàng</div>
                                </div>
                            </div>
                        </div>
                    </div>            
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body"><h5 class="card-title">Thông tin</h5>
                                    <form class="">
                                        ...
                                        <div class="position-relative row form-group"><label for="tu" class="col-sm-2 col-form-label">Đến <abbr lang="required">*</abbr></label>
