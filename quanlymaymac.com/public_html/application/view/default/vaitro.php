                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Danh sách vai trò
                                    <div class="page-title-subheading">Danh sách vai trò
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-inline-block dropdown">
                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-129px, 33px, 0px);">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="#" data-toggle="modal" data-target="#exampleModalLong" data-action="addVT">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="main-card mb-3 card">
                                                ...
                                                <div class="widget-content p-0">
                                                    <div class="widget-content-wrapper">
                                                        ...
                                                        <div class="widget-content-right"><!-- widget-content-actions-->
                                                            <button class="border-0 btn-transition btn btn-outline-success" data-toggle="modal" data-target="#exampleModalLong" data-action="managerole" data-id="<?=$admin->id?>">
                                                                <i class="fa fa-cubes"></i>
                                                            </button>
                                                            <button class="border-0 btn-transition btn btn-outline-success" data-toggle="modal" data-target="#exampleModalLong" data-action="editVT" data-id="<?=$admin->id?>">
                                                                <i class="fa fa-edit"></i>
                                                            </button>
                                                            <button class="border-0 btn-transition btn btn-outline-danger" data-toggle="modal" data-target=".bd-example-modal-sm" data-action="deleteVT" data-id="<?=$admin->id?>">
                                        ...
                                        <div class="d-block text-right card-footer">
                                            ...
                                            <button class="btn btn-warning btn-lg" data-toggle="modal" data-target=".bd-example-modal-sm" data-action="deleteSelectedVT">Xóa</button>
                                        </div>
                                    </div>
                                </div>
