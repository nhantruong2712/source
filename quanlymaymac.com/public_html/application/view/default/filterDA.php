                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="trangthai" id="filterStatus2" value="0" type="checkbox"<?=$status&&in_array(0,$status)?' checked':''?> /> Hủy
                                            </div>
                                        </div>
                                        <div class="d-block text-right card-footer">                                             
                                            <button class="btn btn-warning btn-lg" id="dofilterda">Lọc</button> 
                                        </div>  
                                    </div>
                                </div>
