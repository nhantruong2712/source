...
//sản lượng nhân viên tính trong bảng ngay   theo congdoan, ngay - inner join congdoan
...
$c = db::query("select xxx.*,duan.ten as duanten,congdoan.ten as congdoanten 
    ...
    from ngay where ngay.ngay>='$x0' and ngay.ngay<='$x1' and ngay.type=3) xxx 
                                                        ...
                                                        <?php for($j=0;$j<$max;$j++){?>
                                                          <tr>
                                                            ...
                                                            <td class="fc-event-container"><a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable fc-resizable">
                                                                <div class="fc-content"><span class="fc-time"><?=$ret[$i][$j]->congdoanten.'-'.$ret[$i][$j]->duanten.": "?></span> <span class="fc-title"><?=($ret[$i][$j]->soluong-0)?></span></div>
