...
$c = db::query("select xxx.*,duan.ten as duanten,chuyen.ten as chuyenten 
    ...
    from ngay where ngay.ngay='$x0' and ngay.chuyen>0 and ngay.type=3 and ngay.kho = $kho
                                                          ...
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                              <td class="fc-event-container"><a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable">
                                                                  <div class="fc-content"><span class="fc-time"><?=$ret->chuyenten.'-'.$ret->duanten.": "?></span> <span class="fc-title"><?=($ret->sl-0)?></span></div>
                                                                </a></td>
                                                            </tr>
                                                            <?php }?> 
                                                            </tr>
