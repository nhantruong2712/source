<div class="card-body">
    ...
    <form id="adddtsxform" method="post" class="" novalidate="novalidate">
        <input type="hidden" name="kho" value="<?=$employee->kho?>" />
        ...
        <button class="mt-1 btn btn-primary" type="button" id="adddtsx">Thêm</button>
    </form>
</div>