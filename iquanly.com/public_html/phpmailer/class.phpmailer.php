 ...
 */
  ...
  */
  ...
  public function EncodeQ ($str, $position = 'text') {
    ...
    switch (strtolower($position)) {
      case 'phrase':
        $encoded =  preg_replace_callback("/([^A-Za-z0-9!*+\/ -])/", function($m){return '='.sprintf('%02X', ord($m[1]));}
            //preg_replace("/([^A-Za-z0-9!*+\/ -])/e", "'='.sprintf('%02X', ord('\\1'))"
            , $encoded);
        break;
      case 'comment':
        $encoded = preg_replace_callback("/([\(\)\"])/", function($m){return '='.sprintf('%02X', ord($m[1]));}
        // preg_replace("/([\(\)\"])/e", "'='.sprintf('%02X', ord('\\1'))"
        , $encoded);
      case 'text':
      default:
        ...
        $encoded = preg_replace_callback('/([\000-\011\013\014\016-\037\075\077\137\177-\377])/'
            ...
            //preg_replace('/([\000-\011\013\014\016-\037\075\077\137\177-\377])/e',"'='.sprintf('%02X', ord('\\1'))"
            , $encoded);
        break;
    }
